...
public class Vpdnuevos extends JPanel{
	...
	public Vpdnuevos() {
		...
		lblListaDeProductos.setFont(new Font("Segoe UI Light", Font.BOLD, 20));
		...
		btnBuscarN.setFont(new Font("Segoe UI Light", Font.BOLD, 20));
		btnBuscarN.setBackground(Color.WHITE);
		btnBuscarN.setBounds(153, 127, 90, 44);
		add(btnBuscarN);
