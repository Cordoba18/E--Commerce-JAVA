...
public class Vpdantiguos extends JPanel{
	...
	public Vpdantiguos() {
		...
		lblListaPdAntiguos.setFont(new Font("Segoe UI Light", Font.BOLD, 20));
		...
		btnBuscarA.setFont(new Font("Segoe UI Light", Font.BOLD, 20));
		btnBuscarA.setBackground(Color.WHITE);
		btnBuscarA.setBounds(153, 127, 90, 44);
		add(btnBuscarA);
